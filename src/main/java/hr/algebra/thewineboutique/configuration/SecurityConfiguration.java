    ...
    SecurityFilterChain web(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers("/TheWineBoutique/succes","/TheWineBoutique/cancel","/TheWineBoutique/pay","/TheWineBoutique/order/submit", "/TheWineBoutique/order", "/TheWineBoutique/order/complete", "/TheWineBoutique/orderConfirmation", "/TheWineBoutique/paypal").hasRole("USER")
                        .requestMatchers("/TheWineBoutique/succes","/TheWineBoutique/cancel","/TheWineBoutique/pay", "/TheWineBoutique/order/submit","/TheWineBoutique/order", "/TheWineBoutique/orderConfirmation", "/TheWineBoutique/order/complete","/TheWineBoutique/paypal", "/TheWineBoutique/newWine", "/TheWineBoutique/edit/**", "/TheWineBoutique/delete/**", "/TheWineBoutique/confirmDelete/**").hasRole("ADMIN")
